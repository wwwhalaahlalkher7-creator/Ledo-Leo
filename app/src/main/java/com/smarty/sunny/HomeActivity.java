...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        int[] layoutIds = {
            ...
            R.id.p5layout, R.id.p6layout, R.id.p7layout, R.id.p8layout,
            R.id.p9layout, R.id.p10layout, R.id.p11layout, R.id.p12layout,
            R.id.p13layout, R.id.p14layout, R.id.p15layout, R.id.p16layout,
            R.id.p17layout, R.id.p18layout, R.id.p19layout, R.id.p20layout,
            R.id.p21layout, R.id.p22layout, R.id.p23layout, R.id.p24layout,
            R.id.p25layout, R.id.p26layout, R.id.p27layout, R.id.p28layout,
            R.id.p29layout, R.id.p30layout, R.id.p31layout, R.id.p32layout,
            R.id.p33layout, R.id.p34layout, R.id.p35layout, R.id.p36layout,
            R.id.p37layout, R.id.p38layout, R.id.p39layout, R.id.p40layout,
            R.id.p41layout, R.id.p42layout, R.id.p43layout, R.id.p44layout,
            R.id.p45layout, R.id.p46layout, R.id.p47layout, R.id.p48layout
        };
